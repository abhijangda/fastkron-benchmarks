...
int size_i = kronRow;
int size_j = kronRow;
int size_A = size_a * size_b * size_c * size_d * size_e * size_f * size_g * size_h * size_i ;
...
sd_t_d2_fusion_(size_a,size_b,size_c,size_d,size_e,size_f,size_g,size_h,size_i,size_j,host_C, host_A, host_B, 1, -1);
return 0;
} 