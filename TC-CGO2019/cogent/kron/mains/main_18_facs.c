...
int size_s = kronRow;
int size_t = kronRow;
int size_A = size_a * size_b * size_c * size_d * size_e * size_f * size_g * size_h * size_i * size_j * size_k * size_l * size_m * size_n * size_o * size_p * size_q * size_r * size_s ;
...
sd_t_d2_fusion_(size_a,size_b,size_c,size_d,size_e,size_f,size_g,size_h,size_i,size_j,size_k,size_l,size_m,size_n,size_o,size_p,size_q,size_r,size_s,size_t,host_C, host_A, host_B, 1, -1);
return 0;
} 