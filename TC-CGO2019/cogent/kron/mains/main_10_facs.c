...
int size_k = kronRow;
int size_l = kronRow;
int size_A = size_a * size_b * size_c * size_d * size_e * size_f * size_g * size_h * size_i * size_j * size_k ;
...
sd_t_d2_fusion_(size_a,size_b,size_c,size_d,size_e,size_f,size_g,size_h,size_i,size_j,size_k,size_l,host_C, host_A, host_B, 1, -1);
return 0;
} 